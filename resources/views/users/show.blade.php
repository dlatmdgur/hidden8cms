                    ...
                    <div class="x_panel">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Phone:</strong>
                                    {!! Form::text('phone', null, array('placeholder' => 'Phone','class' => 'form-control', 'readonly')) !!}
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    @foreach($permissions as $permission)
                                        @if (in_array($permission, ['user', 'maintenance', 'master']))
                                            @continue
                                        @endif
                                        @php ($checked = ($user->hasPermissionTo($permission))? "checked" : "")

                                        <label>
                                            <input type="checkbox" name="permission[]" value="{{ $permission }}" class="js-switch" readonly {{ $checked }} /> {{ $names[$permission] }}
                                        </label>
                                    @endforeach
                                </div>
                            </div>
