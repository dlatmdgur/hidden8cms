    ...
    <div class="right_col" role="main">
        <div class="">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">보석 지급/회수 로그</li>
            </ol>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12  ">
                    <div class="x_panel">
                        ...
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>보석 지급/회수 로그<small>(일별)</small></h2>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        title: function() {
                            return '운영로그_보석지급회수로그(일별)_' + $("#search_start_date1").val().replace(/-/gi, '') +'-'+$("#search_end_date1").val().replace(/-/gi, '');
                        }
                    }
                ],
            });
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        title: function() {
                            return '운영로그_보석지급회수로그(개별)_' + $("#search_start_date2").val().replace(/-/gi, '') +'-'+$("#search_end_date2").val().replace(/-/gi, '');
                        }
                    }
                ],
            });
