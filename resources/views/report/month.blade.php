	...
	<div class="right_col" role="main">
		<div class="">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item">월별</li>
			</ol>
			...
			<div class="row">
				<div class="col-md-12 col-sm-12  ">
					<div class="x_panel">
						...
						<form name="frm" method="get" action="{{ route('report.month') }}">
						<div class="input-group">
							<div class="col-12 col-lg-3 col-xl-3 mb-1 input-group">
								<select name="slot_id" id="" class="form-control mb-2">
							...
							<div class="col-12 col-lg-2 col-xl-2 mb-1 input-group">
								<input type="month" name="sdate" value="{{ $sdate }}" class="form-control mb-2" data-check="true" data-msg-false="검색 시작일을 선택하세요." />
							</div>
								...
								<table class="table table-sm table-striped table-bordered table-hover mb-0">
									...
									@forelse($result as $row)
										<tr class="text-center">
											<td>{{ $row->datecode }}</td>
											<td class="pl-3 pr-3 text-right">{{ $slots[$row->slot_id] }}<small class="text-muted ml-2">{{ $row->slot_id }}</small></td>
