	...
	<div class="right_col" role="main">
		<div class="">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item">플레이어</li>
			</ol>
			...
			<div class="row">
				<div class="col-md-12 col-sm-12  ">
					<div class="x_panel">
						...
						<form name="frm" method="get" action="{{ route('report.player') }}">
						<div class="input-group">
							<div class="input-group-prepend">
								<select name="search_type" class="form-control">
									<option value="id" {{ $search_type === 'id' ? 'SELECTED' : '' }}>유저ID</option>
									<option value="useq" {{ $search_type === 'useq' ? 'SELECTED' : '' }}>유저번호</option>
						...
						<div class="row">
							<div class="col p-0" style="overflow-y: hidden; overflow-x: auto;">
								...
								{{ $result->onEachSide(10)->links('layouts.partials.page', ['pageinfo' => $result, 'offset' => 20]) }}
