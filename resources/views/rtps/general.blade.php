	...
	<div class="right_col" role="main">
		<div class="">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item">전역 RTP 설정</li>
			</ol>
	...
	<div id="apply" class="modal fade" tabindex="-1">
		<div class="modal-dialog modal-md">
			<div class="modal-content">
				<form name="frmApply" method="post" action="{{ Route('rtp.general.set') }}" onsubmit="return false;" method-transfer="async" class="m-0">
					<input type="hidden" name="rtp" value="" />

					<div class="modal-header"><h5 class="modal-title"><b>GENERAL RTP SETTING</b></h5></div>
...
$(function ()
{
	...
	$('#apply').on('show.bs.modal', function (e)
	{
		...
		let rtp		= emb.prev().find('select[name="rtp"]').val().split(':');
