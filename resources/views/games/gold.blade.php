    ...
    <div class="right_col" role="main">
        <div class="">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('games.golds') }}">골드내역 조회</a></li>
            </ol>
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <table class="table table-bordered info-table">
                                            <tr>
                                                <th width="15%">보유골드</th>
                                                <td id="user_gold">0</td>
                                                <th width="15%">금고</th>
                                                <td id="safe_gold">0</td>
                                                <th width="15%">저금통</th>
                                                <td id="piggy_gold">0</td>
                                            </tr>
                                            <tr>
                                                <th>날짜 선택</th>
                                                <td colspan="5">
