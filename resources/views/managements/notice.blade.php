    ...
    <div class="right_col" role="main">
        <div class="">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">포커 공지</li>
            </ol>
            ...
            $('#btn-preview').off('click').on('click', function () {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        showPreview('notice', '/preview/notice/NoticeList.html');
                    },
                    error: function(data) {
                        if (data.status === 419) {
                            alert('세션이 만료되었습니다.');
            ...
            $('#btn-publish').off('click').on('click', function () {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        showPublish('notice', '/publish/notice/NoticeList.html');
                    },
                    error: function(data) {
                        if (data.status === 419) {
                            alert('세션이 만료되었습니다.');
