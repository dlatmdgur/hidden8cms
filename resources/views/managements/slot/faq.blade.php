    ...
    <div class="right_col" role="main">
        <div class="">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">슬롯 FAQ</li>
            </ol>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#btn-preview').off('click').on('click', function () {
                ...
                $.ajax({
                    type: 'GET',
                    url: '/management/slot/previewFaq',
                    data: {
                        from: 'faq'
                    },
                    dataType: 'json',
                    success: function(data) {
                        ...
                        showPreview('faq', '/preview/slot/faq/FaqList.html');
                    },
                    error: function(data) {
                        if (data.status === 419) {
                            alert('세션이 만료되었습니다.');
            ...
            $('#btn-publish').off('click').on('click', function () {
                ...
                $.ajax({
                    type: 'GET',
                    url: '/management/slot/publishFaq',
                    data: {
                        from: 'faq'
                    },
                    dataType: 'json',
                    success: function(data) {
                        ...
                        showPublish('faq', '/publish/slot/faq/FaqList.html');
                    },
                    error: function(data) {
                        if (data.status === 419) {
                            alert('세션이 만료되었습니다.');
