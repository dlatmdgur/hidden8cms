...
return [
    ...
    */
    ...
    'date_equals' => ':attribute 날짜가 :date와 일치 하지 않습니다.',
    ...
    'dimensions' => ':attribute 가 유효하지 않은 이미지 크기를 가지고 있습니다.',
    'distinct' => ':attribute 값에 중복된 항목이 있습니다.',
    'ends_with' => ':attribute 는 :values 값 중 하나로 끝나야 합니다..',
    ...
    'ipv4' => ':attribute 값이 유효한 IPv4 주소가 아닙니다.',
    'ipv6' => ':attribute 값이 유효한 IPv6 주소가 아닙니다..',
    ...
    'mimetypes' => ':attribute 값이 :values 와(과) 다른 형식입니다.',
    'min' => [
    ...
    'starts_with' => ':attribute 값은 :values 값 중 하나로 시작해야합니다.',
    ...
    'uploaded' => ':attribute 를 업로드 하는데 실패하였습니다.',
    'uuid' => ':attribute 는 유효한 UUID 값이어야 합니다.',
