...
class CsSlotNotice extends BaseModel
{
    public $timestamps = false;
    public $incrementing = true;
    protected $connection = 'mysql';
    protected $table = 'cms_game.cs_slot_notice';
    ...
    {
        $sql = "SELECT max(`order`) as maxOrder from cms_game.cs_slot_notice;";
...
//        }
    ...
    {
        $sql = " UPDATE cms_game.cs_slot_notice SET `order` = ? WHERE id = ? ";
    ...
    {
        $idSet = implode(',', $ids);
        $sql = "UPDATE cms_game.cs_slot_notice SET " .
            " `" . $colName . "` = '" . $colValue . "' " .
